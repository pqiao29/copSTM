...
#' true_beta <- c(-1, 1, 0.5, -0.5, 0, 1)
#' true_rho <- c(-0.3, 0, 0.3, 0)
#' sim_dat <- sim_data(10, n, K, t_size, true_beta, true_rho) 
...
#' gm <- 0.5  
#' set.seed(444)
#' start <- Sys.time()  # expected around 2 mins 
#' select_est <- copSTModelSelect(sim_dat$covariates, sim_dat$response, K = K, n = n, 
